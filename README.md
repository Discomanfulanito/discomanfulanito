...
<span>
<strong>AI</strong> and <strong>math</strong> student and language enthusiast building ML projects and learning in public. Having fun with <strong>web development.</strong> Fascinated by <strong>cryptography</strong>, <strong>natural language processing</strong> and <strong>open source software</strong>.
<br/>
<br/>

  Member of <a href="https://github.com/MaoMao-Corp/">MaoMao Corp</a> and volunteer for <a href="https://annas-archive.li">Anna's Archive</a>.
<br/><br/>
